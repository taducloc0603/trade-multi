...
public:
   ...
   static void PackUInt32(uchar &buf[], int offset, uint value) {
      struct UInt32Pack { uint v; } p;
      p.v = value;
      uchar tmp[];
      ArrayResize(tmp, 4);
      StructToCharArray(p, tmp, 0);
   ...
   static void PackInt64(uchar &buf[], int offset, long value) {
      struct Int64Pack { long v; } p;
      p.v = value;
      uchar tmp[];
      ArrayResize(tmp, 8);
      StructToCharArray(p, tmp, 0);
   ...
   static uint UnpackUInt32(uchar &buf[], int offset) {
      struct UInt32Pack { uint v; } p;
      uchar tmp[];
      ArrayResize(tmp, 4);
      ArrayCopy(tmp, buf, 0, offset, 4);
