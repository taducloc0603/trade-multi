...
public sealed class DashboardViewModel : ObservableObject
{
    ...
    private void SyncPortfolioCoordinatorConfig()
    {
        ...
        _portfolioCoordinator.UpdateSameActionLockConfig(
            ...
            _runtimeConfigState.CurrentSameActionLockEnabled);
        _portfolioCoordinator.UpdateCloseSameActionLockConfig(
            ...
            _runtimeConfigState.CurrentCloseSameActionLockEnabled);
    ...
    // start HOẶC end null trong DB → nhóm same-action tắt.
    private static string FormatSameActionRange(int? startSeconds, int? endSeconds)
        => startSeconds.HasValue && endSeconds.HasValue ? $"{startSeconds}..{endSeconds}s" : "OFF";
    ...
    private async Task InitializeRuntimeConfigAsync()
    {
        ...
        try
        {
            ...
            {
                ClearConfigError();
                foreach (var configWarning in GapThresholdConfigWarnings.Evaluate(
                ...
                _runtimeConfigState.Update(
                    ...
                    openMaxLastGapPts: result.OpenMaxLastGapPts,
                    ...
                    rdStartSameActionLockSeconds: result.RdStartSameActionLockSeconds ?? -1,
                    rdEndSameActionLockSeconds: result.RdEndSameActionLockSeconds ?? -1,
                    ...
                    closeRdStartSameActionLockSeconds: result.CloseRdStartSameActionLockSeconds ?? -1,
                    closeRdEndSameActionLockSeconds: result.CloseRdEndSameActionLockSeconds ?? -1,
                    // start HOẶC end null trong DB → tắt nhóm đó (không chờ same-action).
                    sameActionLockEnabled: result.RdStartSameActionLockSeconds.HasValue && result.RdEndSameActionLockSeconds.HasValue,
                    closeSameActionLockEnabled: result.CloseRdStartSameActionLockSeconds.HasValue && result.CloseRdEndSameActionLockSeconds.HasValue);
        ...
        System.Windows.Application.Current.Dispatcher.Invoke(() =>
        {
            ...
            var portfolioResult = _portfolioCoordinator.ProcessSnapshot(
                ...
                new GapSignalConfirmationConfig(
                    ...
                    OpenMaxLastGapPts: _runtimeConfigState.CurrentOpenMaxLastGapPts));
