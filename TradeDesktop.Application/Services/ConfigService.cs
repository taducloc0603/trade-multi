    ...
    int? OpenMaxLastGapPts = null)
{
    public static ConfigLoadResult Success(
        ...
        new(
            ...
            // null = tắt nhóm same-action (giữ nguyên null); có giá trị thì clamp như cũ.
            rdStartSameActionLockSeconds is { } rdStart ? Math.Max(0, rdStart) : null,
            rdEndSameActionLockSeconds is { } rdEnd ? Math.Max(0, rdEnd) : null,
            closeRdStartSameActionLockSeconds is { } closeRdStart ? Math.Max(0, closeRdStart) : null,
            closeRdEndSameActionLockSeconds is { } closeRdEnd ? Math.Max(0, closeRdEnd) : null,
